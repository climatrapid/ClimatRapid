...
export default async function DiagnosticareReparatiiPage() {
  ...
  return (
    <div className="bg-white text-[#1d2353]">
      <ServicePageJsonLd name="Diagnosticare si reparatii" description="Servicii de diagnosticare si reparatie aer conditionat in Moldova." slug="servicii/diagnosticare" phone={phoneTel} />
